...
namespace DonClub.Infrastructure.Migrations
{
    ...
    [Migration("20260106131835_AddSmsProviderSettings")]
    partial class AddSmsProviderSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Donclub.Domain.Badges.Badge", b =>
                {
                    ...
                    b.Property<decimal?>("RewardWalletAmount")
            ...
            modelBuilder.Entity("Donclub.Domain.Missions.MissionDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MissionDefinitions", "app");
                });

            modelBuilder.Entity("Donclub.Domain.Missions.UserMission", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("UserId", "MissionDefinitionId", "PeriodStartUtc", "PeriodEndUtc")
                        .IsUnique();

                    b.ToTable("UserMissions", "app");
                });

            modelBuilder.Entity("Donclub.Domain.Notifications.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Donclub.Domain.Settings.SmsProviderSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("UseBaseServiceNumber")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("SmsProviderSettings", "app");
            ...
            modelBuilder.Entity("Donclub.Domain.Settings.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Donclub.Domain.Missions.UserMission", b =>
                {
                    b.HasOne("Donclub.Domain.Missions.MissionDefinition", "MissionDefinition")
